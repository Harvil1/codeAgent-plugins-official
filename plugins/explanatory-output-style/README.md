...
session that encourage the agent to:
...
session. This context instructs the agent to provide brief educational explanations
...
CODEAGENT.md, but it is more flexible and allows for distribution through plugins.
