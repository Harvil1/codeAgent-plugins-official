...
|--------|----------|--------------|
| **plugin-dev** | Building CodeAgent plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install CodeAgent automations from Anthropic's official repository or another shared marketplace
- User needs multiple related capabilities
- Team wants standardized workflows
- First-time CodeAgent setup