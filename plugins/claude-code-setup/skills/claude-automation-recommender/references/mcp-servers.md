...
2. **Global config** (`~/.codeAgent.json`) - Available across all projects
...
**Debugging**: Use `uv run python main.py  # MCP 调试看日志 ~/.codeAgent/logs/codeagent.log` to identify configuration issues.
