# CodeAgent Setup Plugin

Analyze codebases and recommend tailored CodeAgent automations - hooks, skills, MCP servers, and more.

## What It Does

the agent uses this skill to scan your codebase and recommend the top 1-2 automations in each category:
