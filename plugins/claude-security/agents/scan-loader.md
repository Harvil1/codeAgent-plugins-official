---
name: scan-loader
description: Restricted read-only loader dispatched by the CodeAgent Security scan workflow to return one candidates file from the run directory; not for direct invocation.
model: sonnet
effort: low
color: cyan
tools: Read
