---
name: scan-verifier
description: Restricted read-only verifier dispatched by the CodeAgent Security scan workflow to vote on one candidate finding; not for direct invocation.
model: inherit
effort: xhigh
color: orange
