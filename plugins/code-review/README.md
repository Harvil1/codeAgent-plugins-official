...
2. Gathers relevant CODEAGENT.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for CODEAGENT.md compliance
...
- CODEAGENT.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (CODEAGENT.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/CODEAGENT.md says "Use camelCase for functions")
...
- General quality issues (unless in CODEAGENT.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the CodeAgent repository. The command is automatically available when using CodeAgent.

## Best Practices

### Using `/code-review`
- Maintain clear CODEAGENT.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update CODEAGENT.md based on recurring review patterns
...
- CODEAGENT.md files (optional but recommended for guideline checking)
...
- Make CODEAGENT.md more specific about what matters
...
- **Write specific CODEAGENT.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update CODEAGENT.md based on patterns
...
### Agent architecture
- **2x CODEAGENT.md compliance agents**: Redundancy for guideline checks
...
- For CODEAGENT.md issues: verifies guideline explicitly mentions it
