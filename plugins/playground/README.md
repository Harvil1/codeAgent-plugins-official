...
The user adjusts controls, explores visually, then copies the generated prompt back into the agent.
...
Add this plugin to your CodeAgent configuration to enable the playground skill.
