---
name: new-sdk-app
description: Create and setup a new the agent Agent SDK application
---


You are tasked with helping the user create a new the agent Agent SDK application. Follow these steps carefully:

## Reference Documentation

Before starting, review the official documentation to ensure you provide accurate and up-to-date guidance. Use web_fetch to read these pages:
...
**IMPORTANT**: Always check for and use the latest versions of packages. Use WebSearch or web_fetch to verify current versions before installation.
...
2. **Project name** (ask second): "What would you like to name your project?"
   ...
   - If 用户在命令后敲的参数（见本消息末尾原文） is provided, use that as the project name and skip this question
   - Wait for response before continuing
...
6. **Optional: Create .the agent directory structure**:
   - Offer to create `.codeAgent/` directory for agents, commands, and settings
...
1. Check for latest package versions using WebSearch or web_fetch
