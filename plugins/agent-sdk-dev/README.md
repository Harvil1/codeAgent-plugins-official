...
A comprehensive plugin for creating and verifying the agent Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new the agent Agent SDK application.
...
This plugin is included in the CodeAgent repository. To use it:

1. Ensure CodeAgent is installed
