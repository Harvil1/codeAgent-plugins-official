# CODEAGENT.md Update Guidelines

## Core Principle

Only add information that will genuinely help future the agent sessions. The context window is precious - every line must earn its place.
...
- [ ] Would a new the agent session find this helpful?
