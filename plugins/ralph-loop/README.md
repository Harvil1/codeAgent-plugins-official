...
Implementation of the Ralph Wiggum technique for iterative, self-referential AI development loops in CodeAgent.
...
**Location**: `~/.codeAgent/plugins/cache/claude-plugins-official/ralph-wiggum/<hash>/hooks/hooks.json`
...
Run `/help` in CodeAgent for detailed command reference and examples.
