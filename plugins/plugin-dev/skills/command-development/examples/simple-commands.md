...
**File:** `.codeAgent/commands/review.md`
...
**File:** `.codeAgent/commands/security-review.md`
...
**File:** `.codeAgent/commands/test-file.md`

```markdown
---
description: Run tests for specific file
argument-hint: [test-file]
allowed-tools: terminal(npm:*), terminal(jest:*)
---
...
**File:** `.codeAgent/commands/document.md`
...
**File:** `.codeAgent/commands/git-status.md`
...
**File:** `.codeAgent/commands/deploy.md`

```markdown
---
description: Deploy to specified environment
argument-hint: [environment] [version]
allowed-tools: terminal(kubectl:*), Read
---
...
**File:** `.codeAgent/commands/compare-files.md`
...
**File:** `.codeAgent/commands/quick-fix.md`
...
Quickly fix: 用户在命令后敲的参数（见本消息末尾原文）
...
**File:** `.codeAgent/commands/research.md`
...
Research best practices for: 用户在命令后敲的参数（见本消息末尾原文）
...
**File:** `.codeAgent/commands/explain.md`
...
```markdown
---
allowed-tools: terminal(git:*), Read
---
