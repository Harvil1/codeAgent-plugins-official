...
allowed-tools: terminal(gh:*), Read, Grep
---
...
allowed-tools: Write, terminal(git:*)
---
...
Deployment state saved to `.codeAgent/deployment-state.local.md`:
...
allowed-tools: Read, terminal(npm:*)
---

Reading deployment state from `.codeAgent/deployment-state.local.md`...
...
allowed-tools: terminal(git:*), terminal(npm:*), Read
---
...
```markdown
.codeAgent/plugin-name-workflow.local.md:
...
Reading workflow state from .codeAgent/plugin-name-workflow.local.md...

Current stage: @.codeAgent/plugin-name-workflow.local.md
...
State file: @.codeAgent/plugin-name-workflow.local.md
...
Creating: .codeAgent/feature-complete.flag
...
if [ -f .codeAgent/feature-complete.flag ]; then
...
if [ -f .codeAgent/deployment.lock ]; then
...
!`validate.sh`
echo "checkpoint:validation" >> .codeAgent/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .codeAgent/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .codeAgent/deployment-checkpoints.log
...
Written to .codeAgent/deployment-state.local.md
...
Reading state: @.codeAgent/deployment-state.local.md
...
rm .codeAgent/deployment-state.local.md
