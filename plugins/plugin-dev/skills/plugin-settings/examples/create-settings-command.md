...
allowed-tools: ["Write", "ask_user"]
---

# Create Plugin Settings

This command helps users create a `.codeAgent/my-plugin.local.md` settings file.

## Steps

### Step 1: Ask User for Preferences

Use ask_user to gather configuration:
...
Extract answers from ask_user result:
...
Use write_file tool to create `.codeAgent/my-plugin.local.md`:
...
To modify settings, edit this file and restart CodeAgent.
```

### Step 4: Inform User

Tell the user:
- Settings file created at `.codeAgent/my-plugin.local.md`
- Current configuration summary
- How to edit manually if needed
- Reminder: Restart CodeAgent for changes to take effect
