...
description: This skill should be used when the user wants to "create a skill", "add a skill to plugin", "write a new skill", "improve skill description", "organize skill content", or needs guidance on skill structure, progressive disclosure, or skill development best practices for CodeAgent plugins.
version: 0.1.0
---
...
# Skill Development for CodeAgent Plugins

This skill provides guidance for creating effective skills for CodeAgent plugins.
...
**For CodeAgent plugins:** When building a hooks skill, the analysis shows:
...
For CodeAgent plugins, create the skill directory structure:
...
CodeAgent automatically discovers skills:
...
- References include the AI generation prompt from CodeAgent
