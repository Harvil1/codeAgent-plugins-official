...
**Quality Standards:**
- Follows project conventions (check CODEAGENT.md)
...
**Give concrete steps:**
```
✅ Read the file using the read_file tool, then search for patterns using search_files
❌ Analyze the code
...
```markdown
**Analysis Process:**
1. Read code files using read_file tool
