...
3. Check adherence to project best practices and coding standards from CODEAGENT.md
...
2. **Read Code**: Use read_file tool to examine changed files
3. **Analyze Quality**:
...
5. **Best Practices**:
   - Follow project-specific standards from CODEAGENT.md
...
- Missing context (no CODEAGENT.md): Apply general best practices
