...
Comprehensive guidance on CodeAgent plugin architecture, directory layout, and best practices.
...
- Portable path references with `~/.codeAgent/plugins/<插件名>`
...
- Ask about "~/.codeAgent/plugins/<插件名>" usage
...
the agent loads references and examples only as needed based on the task.
