...
| reimagine | `modernized/$1-reimagined/` — note per-service acceptance tests and the `CODEAGENT.md` handoff (reimagine's completion markers; it does NOT write `TRANSFORMATION_NOTES.md`) |
