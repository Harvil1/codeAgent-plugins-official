---
name: session-report
description: Generate an explorable HTML report of CodeAgent session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.codeAgent/projects transcripts.
---

# Session Report

Produce a self-contained HTML report of CodeAgent usage and save it to the current working directory.
...
4. **Edit the output file** (use str_replace, not Write — preserve the template's JS/CSS):
