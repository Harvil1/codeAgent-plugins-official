---
name: maker-setup
description: Onboard a Code-with-Claude Makers Cardputer — fetch the build-with-claude repo, flash firmware, and install the the agent Buddy apps.
---
...
3. When done, tell the user how to launch the agent Buddy and ask what they want to build next (see the `cardputer-buddy` skill for iterating).
