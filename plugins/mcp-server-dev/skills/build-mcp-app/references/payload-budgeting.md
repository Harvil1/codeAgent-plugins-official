...
Hosts cap tool-result text. claude.ai and the agent Desktop truncate at roughly
**150,000 characters**; CodeAgent at ~25k tokens. When a tool result exceeds
...
Geometry, image bytes, or any blob the widget needs but the agent doesn't should
