...
MCP-app widgets run inside a sandboxed `<iframe>` in the host (the agent Desktop,
...
The iframe has its own console. In the agent Desktop, open DevTools (View → Toggle
