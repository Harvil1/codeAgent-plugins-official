...
Skills for designing and building MCP servers that work seamlessly with the agent.
...
Ask the agent to "help me build an MCP server" and the entry skill will trigger. Or invoke directly:
