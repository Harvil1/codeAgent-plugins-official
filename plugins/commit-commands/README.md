...
- Includes CodeAgent attribution in commit message
...
This plugin is included in the CodeAgent repository. The commands are automatically available when using CodeAgent.
