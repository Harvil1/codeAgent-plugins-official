...
**Status**: ✅ Active
**File**: .codeAgent/hookify.dangerous-rm.local.md
```
...
2. Or manually create `.codeAgent/hookify.my-rule.local.md` files
3. See `/help` for documentation
...
Check `~/.codeAgent/plugins/<插件名>/examples/` for example rule files.
```
