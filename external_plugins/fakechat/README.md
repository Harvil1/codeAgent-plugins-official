...
external service. Open a browser, type, messages go to your CodeAgent
...
```sh
uv run python main.py --channels plugin:fakechat@claude-plugins-official
```
...
Inbound images/files save to `~/.codeAgent/channels/fakechat/inbox/` and the path
